...
CREATE INDEX IF NOT EXISTS idx_passenger_seats_passenger ON passenger_seats(passenger_id);
...
CREATE INDEX IF NOT EXISTS idx_search_history_route ON search_history(origin_airport_id, destination_airport_id);
CREATE INDEX IF NOT EXISTS idx_search_history_dates ON search_history(departure_date, return_date);
